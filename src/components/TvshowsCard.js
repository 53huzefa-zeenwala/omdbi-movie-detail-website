    ...
    <div data-theme={theme} className="movie-card" style={data.poster_path ? background : notFound}>
      <div className="overlay">
        <div className="content">
          <p id="name">
            {data.original_name ? data.original_name : 'not found'}
          </p>
          ...
          {data.id && <button>
            <Link style={{textDecoration:'none',color:'inherit'}} to={`/tvshowdetails/${data.id}`}>More Detail</Link>
          </button>}
        </div>
      </div>
    </div>
